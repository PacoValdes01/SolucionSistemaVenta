...
namespace SistemaVenta.BLL.Implementacion
{
    public class CategoriaService : ICategoriaService
    {
        ...
        public async Task<Categoria> Editar(Categoria entidad)
        {
            try
            {
                //IQueryable<Categoria> queryCategoria = await _repositorio.Consultar(c => c.IdCategoria == entidad.IdCategoria);
                //Categoria categoria_encontrada = queryCategoria.First();
        ...
        public async Task<bool> Eliminar(int idCategoria)
        {
            try
            {
                Categoria categoria_encontrada = await _repositorio.Obtener(categoria => categoria.IdCategoria == idCategoria);
        ...
        public async Task<List<Categoria>> CatalogoProductos()
        {
            IQueryable<Categoria> query = await _repositorio.Consultar(p => p.EsActivo == true);
            return query.ToList();
        }
