...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            //if (usuario_existe != null) Este es el original
            if (usuario_existe == null)
                throw new TaskCanceledException("UPS. El correo ya existe.");
        ...
        {
            string clave_encriotada = _utilidadesService.ConvertirSha256(clave);
            Usuario usuario_encontrado = await _repositorio.Obtener(u => u.Correo.Equals(correo) 
            && u.Clave.Equals(clave_encriotada));
        ...
        public async Task<bool> CambiarClave(int IdUsuario, string ClaveActual, string ClaveNueva)
        {
            try
            {
                ...
                if (usuario_encontrado.Clave != _utilidadesService.ConvertirSha256(ClaveActual))
                    //throw new TaskCanceledException("La contraeña actual ingresada no es correcta.");
                return false;
        ...
        public async Task<bool> RestablecerClave(string correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("No encontramos ningún usuario asociado al correo electrónico.");
                ...
                if (!correo_enviado)
                    throw new TaskCanceledException("Tenemos Problemas. Favor de intentarlo de nuevo más tarde.");
